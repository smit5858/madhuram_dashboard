...
// Gated on "update" only (never "create") — same permission as every other add/edit-line-item
// action below (addSaleItem, updateSaleItem, payments), regardless of whether this is backing a
// brand-new sale still being composed or an existing one being edited.
router.post("/quick-add-product", authenticate, authorize("/sells", "update"), saleController.quickAddProduct);
