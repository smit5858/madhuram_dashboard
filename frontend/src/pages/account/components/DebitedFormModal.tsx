...
const DebitedFormModal = ({ debtor, onClose }: DebitedFormModalProps) => {
  ...
  const initialValues: FormValues = {
    ...
    phone: normalizePhoneDigits(debtor?.phone) || "",
                ...
                {isEdit ? (
                  <div className="sm:col-span-2">
                    ...
                    <input
                      readOnly
                      disabled
                      value={`${debtor!.name} — ${formatPhoneDisplay(debtor!.phone)}`}
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 px-3 py-2">
                      <span className="text-xs text-slate-700">{selectedCustomer.name} — {formatPhoneDisplay(selectedCustomer.phone)}</span>
                      <button
                        type="button"
                        onClick={() => {
